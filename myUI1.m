...
if strcmp(action,'initialize'),
   ...
   labelStr = 'myStart';%getString(message('MATLAB:demos:shared:LabelStart'));
   cmdStr = 'start';
   callbackStr = 'myUI(''start'');';
   ...
   btnNumber = 2;
   yPos = 0.90-(btnNumber-1)*(btnWid+spacing);
   labelStr = 'myStop';%getString(message('MATLAB:demos:shared:LabelStop'));
   ...
   % ====================================
   % The INFO button
   labelStr = 'myInfo'; %getString(message('MATLAB:demos:shared:LabelInfo'));
   callbackStr = 'myUI(''info'')';
   infoHndl = uicontrol( ...
      'Style','push', ...
      'Units','normalized', ...
   ...
   % ====================================
   % The CLOSE button
   labelStr = 'myClose'; %getString(message('MATLAB:demos:shared:LabelClose'));
